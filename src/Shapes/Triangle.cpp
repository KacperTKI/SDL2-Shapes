...
Triangle::Triangle() : Triangle(Vec2D::sZERO, Vec2D::sZERO, Vec2D::sZERO)
{
...
{
    // get the full area of out triangle
    // then get the areas of three sub-triangles with p
    // if the three sub-areas do not equal the full area then the point is not in the triangle
...
{
    Vec2D difference = p - GetCenterPoint();
